...
assert 'unified-workspace.css?v=45' in index, 'unified workspace css cache target not found'
index = index.replace('unified-workspace.css?v=45', 'unified-workspace.css?v=46', 1)
