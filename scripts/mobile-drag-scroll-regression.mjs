...
assert.match(index,/unified-workspace\.css\?v=66/,'mobile drag CSS cache must be refreshed');
...
assert.match(index,/unified-workspace\.js\?v=100/,'mobile drag JavaScript cache must be refreshed');
