...
import("./time-block-planner.js?v=1").catch((error) => console.error("시간블럭 기능 로드 실패", error));
import("./time-block-compact.js?v=1").catch((error) => console.error("시간블럭 간단 보기 로드 실패", error));